...
public class SimonSays extends KeyAdapter {
	...
	private void makeAlbum() {
		...
		// a different key"
		JOptionPane.showMessageDialog(a, "Press the matching key when 'Simon says' otherwise press a different key");
	...
	public void keyPressed(KeyEvent e) {
		...
		// score
		if (simonSays & keyCode == imageIndex) {
			win = true;
points++;
...
if(simonSays== false & keyCode == imageIndex) {
	win = false;
	speak("Wrong");
}
if(simonSays==false & keyCode != imageIndex) {
...
System.out.println("Score: " + points);
		...
		if (tries == 10) {
			JOptionPane.showMessageDialog(a, "Good Job! You scored " + points + " out of 10 correct!");
			System.exit(0);
		}
		// 15. exit the program
